...
__export(index_exports, {
  Account: () => Account,
  BCS: () => import_supra_l1_sdk_core17.BCS,
  Block: () => Block,
  Build: () => Build,
  Coin: () => Coin,
  Contract: () => Contract,
  DEFAULT_CHAIN_ID: () => DEFAULT_CHAIN_ID,
  DEFAULT_ENABLE_SIMULATION: () => DEFAULT_ENABLE_SIMULATION,
  DEFAULT_GAS_PRICE: () => DEFAULT_GAS_PRICE,
  DEFAULT_MAX_GAS_FOR_SUPRA_TRANSFER_WHEN_RECEIVER_EXISTS: () => DEFAULT_MAX_GAS_FOR_SUPRA_TRANSFER_WHEN_RECEIVER_EXISTS,
  DEFAULT_MAX_GAS_FOR_SUPRA_TRANSFER_WHEN_RECEIVER_NOT_EXISTS: () => DEFAULT_MAX_GAS_FOR_SUPRA_TRANSFER_WHEN_RECEIVER_NOT_EXISTS,
  DEFAULT_MAX_GAS_UNITS: () => DEFAULT_MAX_GAS_UNITS,
  DEFAULT_RECORDS_ITEMS_COUNT: () => DEFAULT_RECORDS_ITEMS_COUNT,
  DEFAULT_REQUEST_TIMEOUT_MS: () => DEFAULT_REQUEST_TIMEOUT_MS,
  DEFAULT_RPC_VERSION: () => DEFAULT_RPC_VERSION,
  DEFAULT_TXN_TIMEOUT_SEC: () => DEFAULT_TXN_TIMEOUT_SEC,
  DEFAULT_TX_EXPIRATION_DURATION: () => DEFAULT_TX_EXPIRATION_DURATION,
  DEFAULT_WAIT_FOR_TX_COMPLETION: () => DEFAULT_WAIT_FOR_TX_COMPLETION,
  DELAY_BETWEEN_POOLING_REQUEST: () => DELAY_BETWEEN_POOLING_REQUEST,
  Events: () => Events,
  Faucet: () => Faucet,
  FungibleAsset: () => FungibleAsset,
  HexString: () => import_supra_l1_sdk_core17.HexString,
  MAX_RETRY_FOR_TRANSACTION_COMPLETION: () => MAX_RETRY_FOR_TRANSACTION_COMPLETION,
  MILLISECONDS_PER_SECOND: () => MILLISECONDS_PER_SECOND,
  Methods: () => Methods,
  MoveVmError: () => MoveVmError,
  Network: () => Network,
  NetworkInfo: () => NetworkInfo,
  OBJECT_CORE: () => OBJECT_CORE,
  RAW_TRANSACTION_SALT: () => RAW_TRANSACTION_SALT,
  RAW_TRANSACTION_WITH_DATA_SALT: () => RAW_TRANSACTION_WITH_DATA_SALT,
  SUPRA_COIN_TYPE: () => SUPRA_COIN_TYPE,
  SUPRA_FRAMEWORK_ADDRESS: () => SUPRA_FRAMEWORK_ADDRESS,
  Simulate: () => Simulate,
  Submit: () => Submit,
  SupraAPIError: () => SupraAPIError,
  SupraAccount: () => import_supra_l1_sdk_core17.SupraAccount,
  SupraClient: () => SupraClient,
  Table: () => Table,
  Transaction: () => Transaction,
  TransactionStatus: () => TransactionStatus,
  TransactionType: () => TransactionType,
  TxnBuilderTypes: () => import_supra_l1_sdk_core17.TxnBuilderTypes,
  addAddressPadding: () => addAddressPadding,
  getFunctionParts: () => getFunctionParts,
  isMoveVmError: () => isMoveVmError,
...
function standardizeAddress(address) {
  let accountAddress = typeof address === "string" ? import_supra_l1_sdk_core.HexString.ensure(address).toString() : address.toString();
...
var import_supra_l1_sdk_core2 = require("supra-l1-sdk-core");
...
function convertTypeArgsValueToJSONParsable(value) {
  ...
  if (value instanceof import_supra_l1_sdk_core2.TxnBuilderTypes.TypeTag) {
...
function convertTypeArgsValueToMoveTypeValue(value) {
  if (typeof value === "string") {
    return new import_supra_l1_sdk_core2.TypeTagParser(value).parseTypeTag();
  }
  if (value instanceof import_supra_l1_sdk_core2.TxnBuilderTypes.TypeTag) {
    return value;
  }
...
var import_supra_l1_sdk_core9 = require("supra-l1-sdk-core");

// src/internal/transactionManager/txnBuild.ts
var import_supra_l1_sdk_core8 = require("supra-l1-sdk-core");

// src/internal/transaction.ts
var import_supra_l1_sdk_core6 = require("supra-l1-sdk-core");
...
var import_supra_l1_sdk_core3 = require("supra-l1-sdk-core");
...
var parseScriptArgs = (scriptArgs) => {
  ...
  scriptArgs.forEach((arg) => {
    if (arg instanceof import_supra_l1_sdk_core3.TxnBuilderTypes.TransactionArgumentU8) {
      parsedArgs.push({ U8: arg.value });
    } else if (arg instanceof import_supra_l1_sdk_core3.TxnBuilderTypes.TransactionArgumentU32) {
      parsedArgs.push({ U32: arg.value });
    } else if (arg instanceof import_supra_l1_sdk_core3.TxnBuilderTypes.TransactionArgumentU64) {
      parsedArgs.push({ U64: Number(arg.value) });
    } else if (arg instanceof import_supra_l1_sdk_core3.TxnBuilderTypes.TransactionArgumentU128) {
      parsedArgs.push({ U128: Number(arg.value) });
    } else if (arg instanceof import_supra_l1_sdk_core3.TxnBuilderTypes.TransactionArgumentU256) {
      parsedArgs.push({ U256: Array.from(import_supra_l1_sdk_core3.BCS.bcsSerializeU256(arg.value)) });
    } else if (arg instanceof import_supra_l1_sdk_core3.TxnBuilderTypes.TransactionArgumentAddress) {
      parsedArgs.push({ Address: arg.value.toHexString().toString() });
    } else if (arg instanceof import_supra_l1_sdk_core3.TxnBuilderTypes.TransactionArgumentU8Vector) {
      parsedArgs.push({ U8Vector: Array.from(arg.value) });
    } else if (arg instanceof import_supra_l1_sdk_core3.TxnBuilderTypes.TransactionArgumentBool) {
...
var import_supra_l1_sdk_core5 = require("supra-l1-sdk-core");

// src/internal/transactionManager/txnSimulate.ts
var import_supra_l1_sdk_core4 = require("supra-l1-sdk-core");
  ...
  let sendTxPayload = {
    Move: {
      raw_txn: getRawTxnJSONInternal(
        import_supra_l1_sdk_core4.TxnBuilderTypes.RawTransaction.deserialize(
          new import_supra_l1_sdk_core4.BCS.Deserializer(args.serializedRawTransaction)
        )
      ),
  ...
  let sendTxPayload = sendTxnPayloadInternal(
    {
      ...
      rawTxn: import_supra_l1_sdk_core5.TxnBuilderTypes.RawTransaction.deserialize(
        new import_supra_l1_sdk_core5.BCS.Deserializer(args.serializedRawTransaction)
      )
    }
  );
...
async function submitSerializedRawTransactionAndSignatureInternal(args, config) {
  let sendTxPayload = {
    Move: {
      raw_txn: getRawTxnJSONInternal(
        import_supra_l1_sdk_core5.TxnBuilderTypes.RawTransaction.deserialize(
          new import_supra_l1_sdk_core5.BCS.Deserializer(args.serializedRawTransaction)
        )
      ),
      authenticator: {
...
// src/internal/transaction.ts
var import_js_sha3 = __toESM(require("js-sha3"), 1);
...
function getTransactionSignatureMessageInternal(args) {
  let preHash = Uint8Array.from(
    Buffer.from(
      import_js_sha3.default.sha3_256(
        args.rawTxn instanceof import_supra_l1_sdk_core6.TxnBuilderTypes.RawTransaction ? RAW_TRANSACTION_SALT : RAW_TRANSACTION_WITH_DATA_SALT
      ),
      "hex"
    )
  );
  let rawTxSerializedData = new Uint8Array(import_supra_l1_sdk_core6.BCS.bcsToBytes(args.rawTxn));
...
function signTransactionInternal(args) {
  ...
  if (args.rawTxn instanceof import_supra_l1_sdk_core6.TxnBuilderTypes.MultiAgentRawTransaction || args.rawTxn instanceof import_supra_l1_sdk_core6.TxnBuilderTypes.FeePayerRawTransaction) {
    const signerSignature = new import_supra_l1_sdk_core6.TxnBuilderTypes.Ed25519Signature(
      signatureBuffer.toUint8Array()
    );
    return new import_supra_l1_sdk_core6.TxnBuilderTypes.AccountAuthenticatorEd25519(
      new import_supra_l1_sdk_core6.TxnBuilderTypes.Ed25519PublicKey(args.senderAccount.signingKey.publicKey),
      signerSignature
    );
  }
...
async function publishPackageInternal(args, config) {
  let codeSerializer = new import_supra_l1_sdk_core6.BCS.Serializer();
  let modulesTypeCode = [];
  args.modulesCode.map((module2) => {
    modulesTypeCode.push(
      new import_supra_l1_sdk_core6.TxnBuilderTypes.Module(Uint8Array.from(module2))
    );
  });
  import_supra_l1_sdk_core6.BCS.serializeVector(modulesTypeCode, codeSerializer);
  let sendTxPayload = sendTxnPayloadInternal({
    senderAccount: args.senderAccount,
    rawTxn: await rawTxnObjectInternal({
      ...
      functionTypeArgs: [],
      functionArgs: [import_supra_l1_sdk_core6.BCS.bcsSerializeBytes(args.packageMetadata), codeSerializer.getBytes()],
...
var import_supra_l1_sdk_core7 = require("supra-l1-sdk-core");
var DynamicTransactionSerializer = class {
  ...
  serializeAddress(value, serializer) {
    ...
    const addressBytes = new import_supra_l1_sdk_core7.HexString("0x" + cleanAddress).toUint8Array();
  ...
  prepareTransactionArgs(args, paramTypes) {
    ...
    return args.map((arg, index) => {
      const serializer = new import_supra_l1_sdk_core7.BCS.Serializer();
...
// src/internal/transactionManager/txnBuild.ts
var import_js_sha32 = __toESM(require("js-sha3"), 1);
...
function rawTxnObjectInnerInternal(args, config) {
  let senderAddress = typeof args.senderAddress === "string" ? new import_supra_l1_sdk_core8.HexString(args.senderAddress.toString()) : args.senderAddress;
  return new import_supra_l1_sdk_core8.TxnBuilderTypes.RawTransaction(
    new import_supra_l1_sdk_core8.TxnBuilderTypes.AccountAddress(senderAddress.toUint8Array()),
    ...
    new import_supra_l1_sdk_core8.TxnBuilderTypes.ChainId(config.chainId)
  );
}
function rawTxnObjectInternal(args, config) {
  let payload = new import_supra_l1_sdk_core8.TxnBuilderTypes.TransactionPayloadEntryFunction(
...
function buildEntryFunctionInternal(args) {
  let { moduleAddress, moduleName, functionName } = getFunctionParts(args.function);
  return new import_supra_l1_sdk_core8.TxnBuilderTypes.EntryFunction(
    new import_supra_l1_sdk_core8.TxnBuilderTypes.ModuleId(
      new import_supra_l1_sdk_core8.TxnBuilderTypes.AccountAddress(
        new import_supra_l1_sdk_core8.HexString(standardizeAddress(moduleAddress)).toUint8Array()
      ),
      new import_supra_l1_sdk_core8.TxnBuilderTypes.Identifier(moduleName)
    ),
    new import_supra_l1_sdk_core8.TxnBuilderTypes.Identifier(functionName),
    args.functionTypeArgs,
    args.functionArgs
  );
}
function signedTransactionInternal(args) {
  return new import_supra_l1_sdk_core8.TxnBuilderTypes.SignedTransaction(
    args.rawTxn,
    new import_supra_l1_sdk_core8.TxnBuilderTypes.AccountAuthenticatorEd25519(
      new import_supra_l1_sdk_core8.TxnBuilderTypes.Ed25519PublicKey(
        args.senderAccount.pubKey().toUint8Array()
      ),
      new import_supra_l1_sdk_core8.TxnBuilderTypes.Ed25519Signature(
...
function getTransactionPayloadJSONInternal(txPayload) {
  if (txPayload instanceof import_supra_l1_sdk_core8.TxnBuilderTypes.TransactionPayloadEntryFunction) {
    return {
      EntryFunction: {
        module: {
  ...
  } else if (txPayload instanceof import_supra_l1_sdk_core8.TxnBuilderTypes.TransactionPayloadScript) {
    return {
      Script: {
  ...
  } else if (txPayload instanceof import_supra_l1_sdk_core8.TxnBuilderTypes.TransactionPayloadAutomationRegistration) {
    if (txPayload.value instanceof import_supra_l1_sdk_core8.TxnBuilderTypes.AutomationRegistrationParamsV1) {
      return {
  ...
  } else if (txPayload instanceof import_supra_l1_sdk_core8.TxnBuilderTypes.TransactionPayloadMultisig) {
...
function scriptRawTxnObjectInternal(args, config) {
  let payload = new import_supra_l1_sdk_core8.TxnBuilderTypes.TransactionPayloadScript(
    new import_supra_l1_sdk_core8.TxnBuilderTypes.Script(args.scriptCode, args.scriptTypeArgs, args.scriptArgs)
  );
  return rawTxnObjectInnerInternal({
    senderAddress: args.senderAddress,
    senderSequenceNumber: args.senderSequenceNumber,
...
function automationRegistrationRawTxnObjectInternal(args, config) {
  let payload = new import_supra_l1_sdk_core8.TxnBuilderTypes.TransactionPayloadAutomationRegistration(
    new import_supra_l1_sdk_core8.TxnBuilderTypes.AutomationRegistrationParamsV1(
      new import_supra_l1_sdk_core8.TxnBuilderTypes.AutomationRegistrationParamsV1Data(
        buildEntryFunctionInternal({
          function: args.function,
          functionTypeArgs: args.functionTypeArgs,
          functionArgs: args.functionArgs
...
function multisigRawTxnObjectInternal(args, config) {
  let multisigAddress = typeof args.multisigAddress === "string" ? new import_supra_l1_sdk_core8.HexString(args.multisigAddress.toString()) : args.multisigAddress;
  let payload = new import_supra_l1_sdk_core8.TxnBuilderTypes.TransactionPayloadMultisig(
    new import_supra_l1_sdk_core8.TxnBuilderTypes.MultiSig(
      import_supra_l1_sdk_core8.TxnBuilderTypes.AccountAddress.fromHex(multisigAddress),
      new import_supra_l1_sdk_core8.TxnBuilderTypes.MultiSigTransactionPayload(
        buildEntryFunctionInternal({
          function: args.function,
          functionTypeArgs: args.functionTypeArgs,
          functionArgs: args.functionArgs
...
function multisigProposalTxRawTxnObjectInternal(args, config) {
  let multisigAddress = typeof args.multisigAddress === "string" ? new import_supra_l1_sdk_core8.HexString(args.multisigAddress.toString()) : args.multisigAddress;
  let multisigPayload = new import_supra_l1_sdk_core8.TxnBuilderTypes.MultiSigTransactionPayload(
    buildEntryFunctionInternal({
      function: args.function,
      functionTypeArgs: args.functionTypeArgs,
      functionArgs: args.functionArgs
  ...
  let multisigPayloadHash = new import_supra_l1_sdk_core8.HexString(
    import_js_sha32.default.sha3_256(import_supra_l1_sdk_core8.BCS.bcsToBytes(multisigPayload))
  );
  return rawTxnObjectInternal(
    {
      senderAddress: args.senderAddress,
      ...
      functionTypeArgs: [],
      functionArgs: [
        import_supra_l1_sdk_core8.BCS.bcsToBytes(import_supra_l1_sdk_core8.TxnBuilderTypes.AccountAddress.fromHex(multisigAddress)),
        import_supra_l1_sdk_core8.BCS.bcsSerializeBytes(multisigPayloadHash.toUint8Array())
      ],
      optionalTransactionPayloadArgs: args.optionalTransactionPayloadArgs ?? {}
    },
    config
...
var ExtendedRawTransaction = class extends import_supra_l1_sdk_core8.TxnBuilderTypes.RawTransaction {
   ...
   */
  toBytes() {
    return import_supra_l1_sdk_core8.BCS.bcsToBytes(this);
  }
  /**
   ...
   */
  toHexString() {
    return new import_supra_l1_sdk_core8.HexString(uint8ArrayToHexString(import_supra_l1_sdk_core8.BCS.bcsToBytes(this)));
  }
  /**
  ...
  simulate(senderAccountOrAuthenticator) {
    if (senderAccountOrAuthenticator instanceof import_supra_l1_sdk_core8.SupraAccount) {
    ...
    return simulateSerializedTxnInternal({
      ...
      serializedRawTransaction: import_supra_l1_sdk_core8.BCS.bcsToBytes(this)
    }, this.config);
  }
  /**
...
async function transferCoinInternal(args, config) {
  let receiverAccountAddress = typeof args.receiverAccountAddress === "string" ? new import_supra_l1_sdk_core9.HexString(args.receiverAccountAddress.toString()) : args.receiverAccountAddress;
  ...
  let supraTransferPayload = {
    ...
    functionTypeArgs: [new import_supra_l1_sdk_core9.TypeTagParser(args.coinType).parseTypeTag()],
    functionArgs: [receiverAccountAddress.toUint8Array(), import_supra_l1_sdk_core9.BCS.bcsSerializeUint64(args.amount)]
  };
...
async function getCoinInfoInternal(args, config) {
  return await getAccountResourceInternal({
    accountAddress: new import_supra_l1_sdk_core9.HexString(args.coinType.split("::")[0]),
...
var import_supra_l1_sdk_core10 = require("supra-l1-sdk-core");
async function callContractInternal(args, config) {
  const signers = [];
  const functionArguments = [];
  args.functionArguments.forEach((f) => {
    if (f instanceof import_supra_l1_sdk_core10.SupraAccount) {
      signers.push(f);
    } else {
  ...
  if (!(senderAccount instanceof import_supra_l1_sdk_core10.SupraAccount)) {
  ...
  return await submitSerializedRawTransactionInternal({
    senderAccount,
    serializedRawTransaction: import_supra_l1_sdk_core10.BCS.bcsToBytes(simpleRawTxn),
    enableTransactionWaitAndSimulationArgs: args.enableTransactionWaitAndSimulationArgs ?? {}
  }, config);
}
...
var import_supra_l1_sdk_core11 = require("supra-l1-sdk-core");
...
async function transferFungibleAssetInternal(args, config) {
  let receiverAccountAddress = typeof args.receiverAccountAddress === "string" ? new import_supra_l1_sdk_core11.HexString(args.receiverAccountAddress.toString()) : args.receiverAccountAddress;
  let assetAddress = typeof args.assetAddress === "string" ? new import_supra_l1_sdk_core11.HexString(args.assetAddress.toString()) : args.assetAddress;
  ...
  let supraTransferPayload = {
    ...
    functionTypeArgs: [new import_supra_l1_sdk_core11.TypeTagParser("0x1::fungible_asset::Metadata").parseTypeTag()],
    functionArgs: [assetAddress.toUint8Array(), receiverAccountAddress.toUint8Array(), import_supra_l1_sdk_core11.BCS.bcsSerializeUint64(args.amount)]
  };
  let raw_txn = rawTxnObjectInternal(supraTransferPayload, config);
  let sendTxPayload = sendTxnPayloadInternal({ senderAccount: args.senderAccount, rawTxn: raw_txn });
  return await submitTxnInternal({
...
var import_supra_l1_sdk_core15 = require("supra-l1-sdk-core");
...
var import_supra_l1_sdk_core12 = require("supra-l1-sdk-core");
var Build = class {
  /**
   * The networkInformation property is A NetworkConfig object that contains information about the network on which the Supra client is running.
   */
...
var import_supra_l1_sdk_core14 = require("supra-l1-sdk-core");
...
var import_supra_l1_sdk_core13 = require("supra-l1-sdk-core");
var Submit = class {
  /**
   * The networkInformation property is A NetworkConfig object that contains information about the network on which the Supra client is running.
   */
  ...
  async submitRawTransaction(args) {
    return submitSerializedRawTransactionInternal({ ...args, serializedRawTransaction: import_supra_l1_sdk_core13.BCS.bcsToBytes(args.rawTransaction) }, this.networkInformation);
  }
  /**
...
// src/api/transaction.ts
var import_js_sha33 = __toESM(require("js-sha3"), 1);
var Transaction = class {
  ...
  */
  ...
  deriveTransactionHash(args) {
    return import_js_sha33.default.keccak256(import_supra_l1_sdk_core14.BCS.bcsToBytes(args.signedTransaction));
  }
  /**
...
var SupraClient = class {
  ...
  */
   ...
   */
  getChainId() {
    return new import_supra_l1_sdk_core15.TxnBuilderTypes.ChainId(
...
// src/types/move.ts
var import_supra_l1_sdk_core16 = require("supra-l1-sdk-core");
...
// src/index.ts
var import_supra_l1_sdk_core17 = require("supra-l1-sdk-core");
